...
const supportI18n = {
  ...
  de: {
    ...
    writeBeforeSend: "Nachricht eingeben, bevor Sie senden.",
    writeChatBeforeSend: "Nachricht eingeben, bevor Sie senden.",
    notifSuggestion: "Neue Support-Anfrage (Vorschlag)",
    notifIssue: "Neue Support-Anfrage (Problem)",
    suggestionSaved: "Vorschlag übermittelt.",
    issueSaved: "Problem gemeldet.",
    chatSaved: "Nachricht gesendet.",
    businessFallback: "Unternehmen",
    support: "Support",
    pageTitle: "Support",
    openRequests: "offene Anfragen",
    pageSubtitle: "Premium-Support für Ihr Unternehmen – Vorschlag oder Problem melden.",
    supportRequests: "Support-Anfragen",
    open: "Offen",
    knowledgeBase: "Wissensdatenbank",
    faqLegal: "FAQ + Rechtliches",
    terms: "Nutzungsbedingungen",
    privacy: "Datenschutz",
    suggestionTitle: "Verbesserungsvorschlag",
    issueTitle: "Problem melden",
    issueBadge: "Fehler",
    message: "Nachricht",
    suggestionPlaceholder: "z. B. Schnellere wiederkehrende Termine wären hilfreich...",
    issuePlaceholder: "z. B. Auf der Terminseite schließt sich das Formular nach Speichern nicht...",
    suggestionHint: "Ihre Vorschläge helfen uns, die Plattform zu verbessern.",
    issueHint: "Bitte so viele Details wie möglich (Schritte, Browser usw.).",
    send: "Senden",
    sending: "Wird gesendet...",
    historyTitle: "Anfragenverlauf",
    historyHint: "Ihre letzten Vorschläge und Problemberichte.",
    all: "Alle",
    resolved: "Erledigt",
    ...
    you: "Sie",
    supportAgent: "Support",
    supportReply: "Antwort vom Support",
