...
> = {
  ...
  de: {
    ...
    description:
      "Kunde wählen, erhaltenen Betrag und Zahlungsart eingeben. Fehlt der Kunde in der Liste, „Neuer Kunde“ verwenden.",
    customer: "Kunde",
    newCustomer: "Neuer Kunde",
    selectPlaceholder: "Kunde wählen",
    loadingCustomers: "Laden...",
    selectNone: "— Kunde wählen —",
    amount: "Erhaltener Betrag (€)",
    method: "Zahlungsart",
    methodPlaceholder: "z. B. Bar, Karte, Überweisung",
    notes: "Notizen",
    notesPlaceholder: "Optional",
    cancel: "Abbrechen",
    ...
    saving: "Speichern...",
    errorTitle: "Fehler",
    errNoCustomer: "Kunde wählen oder neuen anlegen.",
    errAmount: "Gültigen positiven Betrag eingeben.",
    successTitle: "Zahlung erfasst",
    successDesc: "Die manuelle Zahlung wurde gespeichert.",
    errSave: "Zahlung konnte nicht gespeichert werden",
    newCustomerTitle: "Neuer Kunde",
    newCustomerDesc: "Nach dem Speichern wird dieser Kunde für die Zahlung ausgewählt.",
    customerSavedTitle: "Kunde gespeichert",
    customerSavedDesc: "Sie können mit der Zahlung fortfahren.",
    errCustomerSave: "Kunde konnte nicht gespeichert werden",
  },
}
