...
- **Βραδινό summary** (μετά τις **23:00** τοπική ώρα **Europe/Athens**): συνολικά έσοδα της ημέρας (πληρωμές με `created_at` μέσα στην ημέρα), ολοκληρωμένα ραντεβού της ημέρας, αριθμός ενεργών κρατήσεων για **αύριο**.
- **Πρωινό briefing** (περίπου **08:00** τοπική ώρα **Europe/Athens**): λίστα σημερινών ραντεβού.
